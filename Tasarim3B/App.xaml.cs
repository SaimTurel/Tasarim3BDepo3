...
using Tasarim3B.Activation;
using Tasarim3B.Contracts.Activation;
using Tasarim3B.Contracts.Services;
using Tasarim3B.Contracts.Views;
using Tasarim3B.Core.Contracts.Services;
using Tasarim3B.Core.Services;
using Tasarim3B.Models;
using Tasarim3B.Services;
using Tasarim3B.ViewModels;
using Tasarim3B.Views;
